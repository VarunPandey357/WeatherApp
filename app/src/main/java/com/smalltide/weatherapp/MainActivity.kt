package com.smalltide.weatherapp

import android.Manifest
import android.annotation.SuppressLint
import android.app.Dialog
import com.smalltide.weatherapp.R
...
import com.smalltide.weatherapp.databinding.ActivityMainBinding
import com.smalltide.weatherapp.databinding.DialogCustomProgressBinding
import com.smalltide.weatherapp.models.WeatherResponse
import com.smalltide.weatherapp.network.WeatherService
import retrofit.*
...
private var bindingProgressBar : DialogCustomProgressBinding? = null
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingProgressBar = DialogCustomProgressBinding.inflate(layoutInflater)
                ...
                .withListener(object : MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                        ...
                        if (report.isAnyPermissionPermanentlyDenied) {
                            Toast.makeText(
                                this@MainActivity, "You have denied location permission. Please allow it is mandatory.",
                                Toast.LENGTH_SHORT).show()
                        }
                    }
...
//        )
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            //saw this line in comment section of video 325
            ...
            listCall.enqueue(object : Callback<WeatherResponse> {
                    ...
                    retrofit: Retrofit)
                {
                    ...
                    if (response.isSuccess) {
                        ...
                        //or no need to do step 4 see video 322 do setupUI(weatherList)
                        // START
...
//                        editor.apply()
    ...
    /**
     * these 2 functions for implementing refresh icon
     */
